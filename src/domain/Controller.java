...
public class Controller {
    ...
    public boolean gennemførOrdrer(boolean afBool, String kunde, double pris, double rabat, double depositum, String tidLev, String tidRet, String lev, String ret, ArrayList<Odetaljer> odetaljer, String kommentar, ArrayList<DelOrdre> delordre) {
        ...
        if (currentOrder == null) {
            ...
            if (afBool) {
                updateOrder(kno, pris, rabat, depositum, "", "", afhentning, currentOrder.getStatus(), lev, ret, odetaljer, kommentar, delordre);
            } else {
                updateOrder(kno, pris, rabat, depositum, tidLev, tidRet, afhentning, currentOrder.getStatus(), lev, ret, odetaljer, kommentar, delordre);
            }
            result = true;
        } else {
            result = false;
